...
module ad9744_dds_top #(
    ...
    wire signed [15:0] dac_code_signed = 16'sd8192 - scaled_offset;
    wire [13:0] dac_code_limited =
        (dac_code_signed < 16'sd0)     ? 14'h0000 :
        (dac_code_signed > 16'sd16383) ? 14'h3FFF :
                                         dac_code_signed[13:0];
